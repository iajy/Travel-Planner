          ...
          <motion.div className="flex flex-col gap-10 p-4 m-4">
            ...
            >
              ...
              >
                ...
                <p>
                  Discover London’s timeless charm and immerse yourself <br />
            ...
            >
              <img
                ...
                onClick={() => handlePages("/switzerland")}
              />
              <div
              ...
              >
                ...
                <p>
                  Discover the breathtaking beauty of Switzerland with <br />
          ...
          >
            <div className="relative overflow-hidden rounded-2xl ">
              ...
              >
                ...
                <p>
                  Embark on a mesmerizing trip to India, <br />
                  exploring ancient temples, vibrant markets, diverse
                  landscapes, and the warmth of its rich culture.
                </p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-2xl">
              ...
              >
                ...
                <p>
                  Explore Brazil’s vibrant culture, colorful festivals, and
